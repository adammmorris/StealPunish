...
import ethics.experiments.tbforagesteal.matchvisualizer.ColorBlend;
import ethics.experiments.tbforagesteal.matchvisualizer.ColoredTableRenderer;
...
import ethics.experiments.tbforagesteal.matchvisualizer.LandmarkColorBlendInterpolation;

public class QTableVisualController {
	...
	public QTableVisualController(int rw, int rh, JointReward objectiveRF) {
	...
	public void setMatchAnalyzer(MatchAnalyzer ma){
		this.ma = ma;
	}
