...
import ethics.experiments.fssimple.auxiliary.FSSubjectiveRF_Sym;
 ...
 *
 */
public class FSSimple_Sym implements DomainGenerator {
	...
	protected int maxStateNodeID = 3;
	...
	public FSSimple_Sym(int maxStateNodeID){
	...
	public static void main(String [] args){
		...
		FSSimple_Sym gen = new FSSimple_Sym(3);
		...
		JointReward r = new FSSubjectiveRF_Sym(new FSSimplePOJR_Sym(1., -0.5, -2.5, 0.));
		((FSSubjectiveRF_Sym)r).setParameters(new double[]{0.,0.});
		
		State s = FSSimple_Sym.getInitialState(domain, "player0", "player1", 0, 0);
