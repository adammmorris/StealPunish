...
path_GA_base = "/gpfs/main/home/amm4/git/generalResearch/output/GAOutput/StealPunish/ESS/Mut/";
path_CSV_base = "/gpfs/main/home/amm4/git/generalResearch/output/GAOutput/StealPunish/ESS/Mut/";

def main():
        for i in range(1,9):
                writeCSVForCommon(path_GA_base+`i`+'a/GA.txt',path_CSV_base+`i`+'a/GA_parsed.csv');
                writeCSVForCommon(path_GA_base+`i`+'b/GA.txt',path_CSV_base+`i`+'b/GA_parsed.csv');
...
def writeCSVForCommon(path_GA,path_CSV):
